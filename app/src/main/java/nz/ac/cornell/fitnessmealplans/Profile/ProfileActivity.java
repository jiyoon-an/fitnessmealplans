...
public class ProfileActivity extends AppCompatActivity implements View.OnTouchListener{
    ...
    {
        System.out.println("USER_ID:" + aUser.getUserID());
        System.out.println("CODE_ID:" + aUser.getCodeID());
        System.out.println("AGE:"+ aUser.getAge());
        System.out.println("HEIGHT:"+ aUser.getHeight());
        System.out.println("HEIGHT_CD:" + aUser.getHeightCD());
        System.out.println("WEIGHT:"+ aUser.getWeight());
        System.out.println("WEIGHT_CD:"+ aUser.getWeightCD());
        System.out.println("GENDER_CD:" + aUser.getGenderCD());
        System.out.println("EXERCISE_CD:"+ aUser.getExerciseCD());
        System.out.println("DAILY_CALORIES:" + aUser.getDailyCalorie());
